    ...
    <div>
            ...
            <q-card-section>
                <div class="row items-center no-wrap justify-between">
                    <div class="row items-center">
                        ...
                        <span class="text-h5 text-dark text-uppercase q-ml-sm">payment receipt management</span>
                    </div>
                    <div class="col-auto">
        ...
        <q-page-sticky position="bottom-right" :offset="[18, 18]">
            <q-spinner-oval
                ...
                size="3em"
            />
            <q-card class="no-shadow custom-border" v-if="!loading && !paymentreceipts.length">
