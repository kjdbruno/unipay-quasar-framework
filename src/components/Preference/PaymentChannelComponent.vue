    ...
    <div>
            ...
            <q-card-section>
                <div class="row items-center no-wrap justify-between">
                    <div class="row items-center">
                        ...
                        <span class="text-h5 text-dark text-uppercase q-ml-sm">payment channel management</span>
                    </div>
                    <div class="col-auto">
                        <q-input outlined dense debounce="300" v-model="filter" placeholder="Search...">
                            <template v-slot:before>
                                <q-btn :disable="page <= 1" @click="PreviousPage" unelevated size="xs" round color="primary" icon="arrow_back"/>
                                <q-btn v-if="paymentchannels.length" unelevated outline size="sm" round color="primary" :label="meta.CurrentPage"/>
        ...
        <q-page-sticky position="bottom-right" :offset="[18, 18]">
            <q-spinner-oval
                ...
                size="3em"
            />
            <q-card class="no-shadow custom-border" v-if="!loading && !paymentchannels.length">
