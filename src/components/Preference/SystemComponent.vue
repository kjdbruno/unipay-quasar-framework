<template>
    <div>
            ...
            <q-card-section>
                <div class="row items-center no-wrap justify-between">
                    <div class="row items-center">
                        ...
                        <span class="text-h5 text-dark text-uppercase q-ml-sm">system management</span>
                    </div>
                    <div class="col-auto">
        ...
        <q-dialog square persistent v-model="modal" position="right" full-height class="dialog-system">
            <q-card class="card-system column full-height">
